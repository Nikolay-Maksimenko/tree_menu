...
def draw_menu(context: Context, menu: str) -> dict[str, any]:
    """
    Template tag for rendering a menu.
    """
...
def get_child_items(items_values, current_item_id, selected_item_id_list):
    """
    Getting child elements of a given item.
    """
...
def get_selected_item_id_list(parent: Item, primary_item: list[Item], selected_item_id: int) -> list[int]:
